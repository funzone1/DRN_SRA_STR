...
EPS = 1e-6
image_root_dir = './data/ownImage/'
image_train_data_dir = image_root_dir + 'train/'
image_train_gt_dir = image_root_dir + 'train_gt/'
image_test_data_dir = image_root_dir + 'test/'
image_test_gt_dir = image_root_dir + 'test_gt/'
...
class OwnLoader(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            data_dirs = [image_train_data_dir]
            gt_dirs = [image_train_gt_dir]
        else:
            data_dirs = [image_test_data_dir]
            gt_dirs = [image_test_gt_dir]
