...
model_urls = {
    'drn_a_50': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',
    'drn2_a_18': base_url + 'resnet18-imagenet.pth',
...
def drn2_a_18(pretrained=False, **kwargs):
    model = DRN_A(BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
        model.load_state_dict(load_url(model_urls['drn2_a_18']), strict=False)
    return model
